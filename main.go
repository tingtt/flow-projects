...
var (
	...
	mysqlDB     = flag.String("mysql-database", getEnv("MYSQL_DATABASE", "flow-projects"), "MySQL database")
	mysqlUser   = flag.String("mysql-user", getEnv("MYSQL_USER", "flow-projects"), "MySQL user")
